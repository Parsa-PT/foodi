...
const ProductMaker = ({data} : any) => {
  ...
  return (
    <div className=' relative flex flex-col gap-10 px-[3rem] py-[4rem]   lg:py-[7rem]  justify-center items-center w-full '>
            ...
            <div className='  w-full grid  grid-cols-1 sm:grid-cols-2 2xl:grid-cols-5  lg:grid-cols-3   xl:grid-cols-4  justify-self-center  self-center    gap-[4rem] '>
              {data.map((item : any) =>(
                    <div className=' relative w-[292px]   px-4 2xl:px-[2rem] pt-4 2xl:pt-7 h-[343px]  flex flex-col items-center gap-7  dropShadow bg-white rounded-[40px] '>

...
const ProductMaker = () => {
  return (
    <div className=' relative flex flex-col gap-10 px-[3rem] py-[4rem]   lg:py-[7rem] max-w-[1482px] justify-center items-center w-full '>
        <div className='   overflow-x-scroll flex gap-10 '>
            ...
            <div className='  w-full grid  grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3  lg:grid-cols-3   xl:grid-cols-4  justify-self-center  self-center    gap-[4rem] '>
                {SpecialDishes2.map((item)=>(
